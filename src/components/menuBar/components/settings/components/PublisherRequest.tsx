...
export default function PublisherRequest() {
    ...
    const [formAlert, setFormAlert] = useState<FormAlertData | null>(null)

    const router = useRouter()

    const formikInitValues: { code: string } = { code: "" }
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <Stack gap={2}>
                <FormAlert {...{ alertData: { severity: "warning", content: "Ezzel a kóddal jogosultságot kapsz az oldal tartalmának módosítására. A kódot az alklamzás tulajdonosa biztosítja." } }} />
